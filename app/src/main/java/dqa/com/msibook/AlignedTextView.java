...
public class AlignedTextView extends LinearLayout {
    private int marginAndPaddingOfLeftRight = dip2px(0);//文本域左右已使用的间距值
    private int lineSpacingExtra = dip2px(5);//文本行距
    private int offset = dip2px(-5);//偏差值,用作于误差调整
    private int textSize = dip2px(18);//字体大小
    private int textColor = Color.parseColor("#828795");// 字体颜色
