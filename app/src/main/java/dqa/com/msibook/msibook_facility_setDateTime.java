...
public class msibook_facility_setDateTime extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_msibook_facility_set_date_time);
...
//                    }
                    ...
                    msibook_facility_setDateTime.this.setResult(RESULT_OK,msibook_facility_setDateTime.this.getIntent().putExtras(bundle));
                    finish();
