...
import static dqa.com.msibook.R.id.project_list_listtop;

public class msibook_dqaweekly_page2_project_list extends AppCompatActivity {
    ...
    private void Find_Week_Project(String DeptID,String Year,String Week) {
        ...
        String Path = "http://wtsc.msi.com.tw/IMS/Weekly_Report.asmx/Find_Week_Project?DeptID=" + DeptID + "&Year=" + Year + "&Week=" + Week;
...
//                                "ModelIDList": "12638,12705"
                    ...
                    listAdapter = new ExpandableListAdapter(msibook_dqaweekly_page2_project_list.this, Week_Project_Item_list, ChildWeek_Project_Item_list);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_msibook_dqaweekly_page2_project_list);
        ...
        //list的Title
        TextView title1 = (TextView) findViewById(project_list_listtop);
...
//
                ...
                intent.setClass(msibook_dqaweekly_page2_project_list.this, msibook_dqaweekly_main_page3_project_detail.class);
                //開啟Activity
...
//
//        // Adding child data
//        listDataHeader.add("DVT");
//        listDataHeader.add("EVT");
//        listDataHeader.add("MP");
//
//        // Adding child data
//        List<String> DVT = new ArrayList<String>();
//        DVT.add("MS-7860");
//        DVT.add("MS-7861");
//        DVT.add("MS-7862");
//
...
//        MP.add("MS-7862");
//
//        listDataChild.put(listDataHeader.get(0), DVT); // Header, Child data
//        listDataChild.put(listDataHeader.get(1), EVT);
