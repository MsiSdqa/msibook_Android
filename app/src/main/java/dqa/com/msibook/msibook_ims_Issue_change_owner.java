...
public class msibook_ims_Issue_change_owner extends AppCompatActivity {
    ...
    List<AppClass_List_Item> _DataList = new ArrayList<AppClass_List_Item>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        setContentView(R.layout.activity_msibook_ims_issue_change_owner);
        ...
        GetServiceData.getString(Path, mQueue, new GetServiceData.VolleyCallback() {
            ...
            public void onSuccess(JSONObject result) {
                ...
                try {
                    ...
                    final List<AppClass_List_Item> Member_List = new ArrayList<AppClass_List_Item>();
                    ...
                    for (int i = 0; i < UserArray.length(); i++) {
                        ...
                        Member_List.add(i, new AppClass_List_Item(MemberName, WorkID));
                    }
