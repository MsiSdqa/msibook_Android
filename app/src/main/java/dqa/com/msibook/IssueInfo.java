...
//        });
    ...
    private void Insert_Issue_Read(String F_Master_ID, String F_Keyin) {
        ...
        String Path = GetServiceData.ServicePathIMS + "/Insert_Issue_Read_Advantage?F_Master_ID=" + F_Master_ID + "&F_Master_Table=" + "C_Issue" + "&F_Read=" + "1" + "&F_Keyin=" + F_Keyin;
...
// start the selector
    ...
    private void Upload_Comment_File(String F_Keyin, String F_Master_ID, String File) {
        ...
        HTTPSTrustManager.allowAllSSL();//信任所有证书，信任憑證
        String Path = GetServiceData.ServicePathIMS + "/Issue_Comment_File_Insert?F_Keyin=" + F_Keyin + "&F_Master_ID=" + F_Master_ID + "&File=" + File;
...
//        pDialog.show();
        ...
        HTTPSTrustManager.allowAllSSL();//信任所有证书，信任憑證
        GetServiceData.uploadImage(GetServiceData.ServicePathIMS + "/Upload_Issue_File_MultiPart", mQueue, ImageFileUpload, "");
    ...
    private void C_Comment_Insert(String Comment) {
        ...
        if (!TextUtils.isEmpty(Comment)) {
            ...
            HTTPSTrustManager.allowAllSSL();//信任所有证书，信任憑證
            String Path = GetServiceData.ServicePathIMS + "/C_Comment_Insert";
...
//        pDialog.show();
        ...
        HTTPSTrustManager.allowAllSSL();//信任所有证书，信任憑證
        String Path = GetServiceData.ServicePathIMS + "/Issue_File_List?F_SeqNo=" + Issue_ID;
...
//                pDialog.hide();
        ...
        try {
            ...
            if (IssueInfoFileArray.length() > 0) {
                ...
                for (int i = 0; i < IssueInfoFileArray.length(); i++) {
                    ...
                    HTTPSTrustManager.allowAllSSL();//信任所有证书，信任憑證
                    String F_DownloadFilePath = GetServiceData.ServicePathIMS + "/Get_File?FileName=" + IssueData.getString("F_DownloadFilePath");
    ...
    private void Issue_Get(String Issue_ID) {
        ...
        HTTPSTrustManager.allowAllSSL();//信任所有证书，信任憑證
        String Path = GetServiceData.ServicePathIMS + "/Issue_Get?F_SeqNo=" + Issue_ID;
    ...
    private void GetIssue_Info(String Issue_ID) {
        ...
        HTTPSTrustManager.allowAllSSL();//信任所有证书，信任憑證
        String Path = GetServiceData.ServicePathIMS + "/GetIssue_Info?IssueID=" + Issue_ID;
...
//        pDialog.show();
        ...
        HTTPSTrustManager.allowAllSSL();//信任所有证书，信任憑證
        String Path = GetServiceData.ServicePathIMS + "/Find_Issue_Comment?Issue_ID=" + Issue_ID;
...
//        DataDialog.show();
    ...
    private void Change_Issue_Owner(final String IssueID, final String WorkID) {
        ...
        if (!TextUtils.isEmpty(IssueID) && !TextUtils.isEmpty(WorkID)) {
            ...
            HTTPSTrustManager.allowAllSSL();//信任所有证书，信任憑證
            String Path = GetServiceData.ServicePathIMS + "/Change_Issue_Owner";
    ...
    private void Change_Issue_Priority(final String IssueID, final String Priority) {
        ...
        if (!TextUtils.isEmpty(IssueID) && !TextUtils.isEmpty(Priority)) {
            ...
            HTTPSTrustManager.allowAllSSL();//信任所有证书，信任憑證
            String Path = GetServiceData.ServicePathIMS + "/Change_Issue_Priority";
    ...
    private void Verify_Issue(final String IssueID, final String WorkID) {
        ...
        if (!TextUtils.isEmpty(IssueID)) {
            ...
            map.put("WorkID", WorkID);
            HTTPSTrustManager.allowAllSSL();//信任所有证书，信任憑證
            String Path = GetServiceData.ServicePathIMS + "/Verify_Issue";
    ...
    private void Reject_Verify_Issue(final String IssueID, final String WorkID) {
        ...
        if (!TextUtils.isEmpty(IssueID)) {
            ...
            map.put("WorkID", WorkID);
            HTTPSTrustManager.allowAllSSL();//信任所有证书，信任憑證
            String Path = GetServiceData.ServicePathIMS + "/Reject_Verify_Issue";
    ...
    private void Close_Issue(final String IssueID, final String WorkID, final String CloseType) {
        ...
        if (!TextUtils.isEmpty(IssueID)) {
            ...
            HTTPSTrustManager.allowAllSSL();//信任所有证书，信任憑證
            String Path = GetServiceData.ServicePathIMS + "/Close_Issue";
