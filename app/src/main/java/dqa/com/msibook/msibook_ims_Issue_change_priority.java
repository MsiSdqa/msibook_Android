...
public class msibook_ims_Issue_change_priority extends AppCompatActivity {
    ...
    private msibook_ims_issue_newIssue_file_adapter mListAdapter;
    ...
    public static List<AppClass_List_Item> _DataList = new ArrayList<AppClass_List_Item>();
    ...
    List<msibook_ims_issue_newIssue_file_item> NewIssueFile_List = new ArrayList<msibook_ims_issue_newIssue_file_item>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_msibook_ims_issue_change_priority);
        ...
        lsv_main.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                new AlertDialog.Builder(msibook_ims_Issue_change_priority.this)
        ...
        mListAdapter = new msibook_ims_issue_newIssue_file_adapter(this, NewIssueFile_List);
            ...
            public void onClick(View arg0) {
                ...
                if (permission != PackageManager.PERMISSION_GRANTED) {
                    ...
                    ActivityCompat.requestPermissions(
                            msibook_ims_Issue_change_priority.this,
                    ...
                    Intent recordIntent = new Intent(mContext, msibook_ims_issue_voice_record.class);
    ...
    private AdapterView.OnItemClickListener listViewOnItemClickListener
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            msibook_ims_issue_newIssue_file_adapter NewIssueFileAdapter = (msibook_ims_issue_newIssue_file_adapter) parent.getAdapter();

            msibook_ims_issue_newIssue_file_item NewIssueFile_Item = (msibook_ims_issue_newIssue_file_item) NewIssueFileAdapter.getItem(position);


        }
    };

    public void Set_Data_List(List<AppClass_List_Item> DataList) {
        _DataList = DataList;
...
//    }
    ...
    private void UpdateIssueFile(String F_Keyin, String F_Master_ID) {
        ...
        List<msibook_ims_issue_upload_image> UploadImage_List = new ArrayList<msibook_ims_issue_upload_image>();
        ...
        if (NewIssueFile_List.size() == 0) {
            ...
            for (msibook_ims_issue_newIssue_file_item FileItem : NewIssueFile_List) {
    ...
    public void UploadIssueFile_File(String UPLOAD_URL, RequestQueue mQueue, File file, String stringPart) {
        ...
        msibook_ims_issue_multipart_request MultiPart = new msibook_ims_issue_multipart_request(UPLOAD_URL,
    ...
    private void AddImageItem(Bitmap Image, String ImageName, String ImagePath) {
        ...
        mListAdapter.addItem(new msibook_ims_issue_newIssue_file_item(Image, ImageName, ImagePath, "", "", msibook_ims_issue_newIssue_file_item.FileType.Image));
    ...
    private void AddListImageItem(ArrayList<String> ImagePathList) {
        ...
        for (String ImagePath : ImagePathList) {
            ...
            mListAdapter.addItem(new msibook_ims_issue_newIssue_file_item(minibm, ImagePath.substring(ImagePath.lastIndexOf("/") + 1), ImagePath, "", "", msibook_ims_issue_newIssue_file_item.FileType.Image));
        }
    ...
    private void AddVideoItem(String VideoPath) {
        ...
        mListAdapter.addItem(new msibook_ims_issue_newIssue_file_item(null, "", "", VideoPath, "", msibook_ims_issue_newIssue_file_item.FileType.Video));
    ...
    private void AddVoiceItem(String VoicePath) {
        ...
        mListAdapter.addItem(new msibook_ims_issue_newIssue_file_item(null, "", "", "", VoicePath, msibook_ims_issue_newIssue_file_item.FileType.Voice));
