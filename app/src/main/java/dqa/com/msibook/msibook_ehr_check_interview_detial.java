...
public class msibook_ehr_check_interview_detial extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_msibook_ehr_check_interview_detial);
        ...
        builder.setMessage("確定應徵!?"+"\n")
                .setPositiveButton("應徵", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        msibook_ehr_check_interview_detial.this.setResult(RESULT_OK,msibook_ehr_check_interview_detial.this.getIntent().putExtras(bundle));
