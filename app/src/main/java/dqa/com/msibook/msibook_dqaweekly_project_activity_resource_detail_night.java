 ...
 * {@link msibook_dqaweekly_project_activity_resource_detail_night.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link msibook_dqaweekly_project_activity_resource_detail_night#newInstance} factory method to
 * create an instance of this fragment.
 */
public class msibook_dqaweekly_project_activity_resource_detail_night extends Fragment {
    ...
    private List<Night_Adapter_Item> Night_Adapter_Item_List_LastWeek = new ArrayList<Night_Adapter_Item>();
    private List<Night_Adapter_Item> Night_Adapter_Item_List = new ArrayList<Night_Adapter_Item>();

    private Integer Save_Total_night_lw;
    private Integer Save_Total_night;

    private Integer Save7850_Total_man_lw;
    private Integer Save7850_Total_night_lw;
    private Integer Save7850_Total_man;
    private Integer Save7850_Total_night;

    private Integer Save7860_Total_man_lw;
    private Integer Save7860_Total_night_lw;
    private Integer Save7860_Total_man;
    private Integer Save7860_Total_night;

    private Integer Save7870_Total_man_lw;
    private Integer Save7870_Total_night_lw;
    private Integer Save7870_Total_man;
    private Integer Save7870_Total_night;

    private Integer Save7880_Total_man_lw;
    private Integer Save7880_Total_night_lw;
    private Integer Save7880_Total_man;
    private Integer Save7880_Total_night;

    private LinearLayout linear_night_up;
    private LinearLayout linear_night_down;
    ...
    private TextView textView_night_totalman;
    ...
    public msibook_dqaweekly_project_activity_resource_detail_night() {
     ...
     * @return A new instance of fragment msibook_dqaweekly_project_activity_resource_detail_night.
     */
    // TODO: Rename and change types and number of parameters
    public static msibook_dqaweekly_project_activity_resource_detail_night newInstance(String param1, String param2) {
        msibook_dqaweekly_project_activity_resource_detail_night fragment = new msibook_dqaweekly_project_activity_resource_detail_night();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mContext = getContext();
        View mView = inflater.inflate(R.layout.fragment_msibook_dqaweekly_project_activity_resource_detail_night, container, false);

        linear_night_up = (LinearLayout) mView.findViewById(R.id.linear_night_up);  //
        ...
        textView_night_totalman = (TextView) mView.findViewById(R.id.textView_night_totalman);  // 遲到總人數
        ...
        linear_night_down = (LinearLayout) mView.findViewById(R.id.linear_night_down);  //
...
//        }
    ...
    public void Find_Total_night_LastWeek(final String Week, final String Year) {
        ...
        Save_Total_night_lw = 0;

        Save7850_Total_man_lw = 0;
        Save7850_Total_night_lw = 0;

        Save7860_Total_man_lw = 0;
        Save7860_Total_night_lw = 0;

        Save7870_Total_man_lw = 0;
        Save7870_Total_night_lw = 0;

        Save7880_Total_man_lw = 0;
        Save7880_Total_night_lw = 0;

        Night_Adapter_Item_List.clear();
                ...
                try {
                    ...
                    if (UserArray.length() > 0) {
                        ...
                        if(SetDept.contains("1")) {
                            ...
                            linear_night_up.setVisibility(View.VISIBLE);
                            linear_night_down.setVisibility(View.VISIBLE);
                            ...
                            for (int i = 0; i < UserArray.length(); i++) {
                                ...
                                Save_Total_night_lw += Integer.valueOf(Night);

                                if (F_DeptCode.contains("785")) {
                                    Save7850_Total_man_lw += Integer.valueOf(TotalMan);
                                    Save7850_Total_night_lw += Integer.valueOf(Night);
                                } else if (F_DeptCode.contains("786")) {
                                    Save7860_Total_man_lw += Integer.valueOf(TotalMan);
                                    Save7860_Total_night_lw += Integer.valueOf(Night);
                                } else if (F_DeptCode.contains("787")) {
                                    Save7870_Total_man_lw += Integer.valueOf(TotalMan);
                                    Save7870_Total_night_lw += Integer.valueOf(Night);
                                } else if (F_DeptCode.contains("788")) {
                                    Save7880_Total_man_lw += Integer.valueOf(TotalMan);
                                    Save7880_Total_night_lw += Integer.valueOf(Night);
                                }

                            }
                            //Night_Adapter_Item_List.add(0, new Night_Adapter_Item(String.valueOf(Save7850_Total_man),"7850",String.valueOf(Save7850_Total_night)));
                            Night_Adapter_Item_List_LastWeek.add(0, new Night_Adapter_Item(String.valueOf(Save7850_Total_man_lw),"7850",String.valueOf("N/A")));
                            Night_Adapter_Item_List_LastWeek.add(1, new Night_Adapter_Item(String.valueOf(Save7860_Total_man_lw),"7860",String.valueOf(Save7860_Total_night_lw)));
                            Night_Adapter_Item_List_LastWeek.add(2, new Night_Adapter_Item(String.valueOf(Save7870_Total_man_lw),"7870",String.valueOf(Save7870_Total_night_lw)));
                            //Night_Adapter_Item_List.add(3, new Night_Adapter_Item(String.valueOf(Save7880_Total_man),"7880",String.valueOf(Save7880_Total_night)));
                            Night_Adapter_Item_List_LastWeek.add(3, new Night_Adapter_Item(String.valueOf(Save7880_Total_man_lw),"7880",String.valueOf("N/A")));

                            Find_Total_night(Week,Year);
    ...
    public void Find_Total_night(String Week,String Year) {
        ...
        Save7850_Total_night = 0;

        Save7860_Total_man = 0;
        Save7860_Total_night = 0;

        Save7870_Total_man = 0;
        Save7870_Total_night = 0;

        Save7880_Total_man = 0;
        Save7880_Total_night = 0;
                    ...
                    if (UserArray.length() > 0) {
                        ...
                        if(SetDept.contains("1")) {
                            ...
                            for (int i = 0; i < UserArray.length(); i++) {
                                ...
                                Save_Total_night += Integer.valueOf(Night);


                                if (F_DeptCode.contains("785")) {
                                    Save7850_Total_man += Integer.valueOf(TotalMan);
                                    Save7850_Total_night += Integer.valueOf(Night);
                                } else if (F_DeptCode.contains("786")) {
                                    Save7860_Total_man += Integer.valueOf(TotalMan);
                                    Save7860_Total_night += Integer.valueOf(Night);
                                } else if (F_DeptCode.contains("787")) {
                                    Save7870_Total_man += Integer.valueOf(TotalMan);
                                    Save7870_Total_night += Integer.valueOf(Night);
                                } else if (F_DeptCode.contains("788")) {
                                    Save7880_Total_man += Integer.valueOf(TotalMan);
                                    Save7880_Total_night += Integer.valueOf(Night);
                                }


                            }
                            //Night_Adapter_Item_List.add(0, new Night_Adapter_Item(String.valueOf(Save7850_Total_man),"7850",String.valueOf(Save7850_Total_night)));
                            Night_Adapter_Item_List.add(0, new Night_Adapter_Item(String.valueOf(Save7850_Total_man),"7850",String.valueOf("N/A")));
                            Night_Adapter_Item_List.add(1, new Night_Adapter_Item(String.valueOf(Save7860_Total_man),"7860",String.valueOf(Save7860_Total_night)));
                            Night_Adapter_Item_List.add(2, new Night_Adapter_Item(String.valueOf(Save7870_Total_man),"7870",String.valueOf(Save7870_Total_night)));
                            //Night_Adapter_Item_List.add(3, new Night_Adapter_Item(String.valueOf(Save7880_Total_man),"7880",String.valueOf(Save7880_Total_night)));
                            Night_Adapter_Item_List.add(3, new Night_Adapter_Item(String.valueOf(Save7880_Total_man),"7880",String.valueOf("N/A")));


                            textView_night_totalman.setText(String.valueOf(Save_Total_night));

                            if(Double.valueOf(Save_Total_night) > Double.valueOf(Save_Total_night_lw)){
                                textView_updown_totalman.setVisibility(View.VISIBLE);
                                textView_updown_totalman.setBackgroundResource(R.mipmap.dqaweekly_ic_upgrade);
                            }else if(Double.valueOf(Save_Total_night) < Double.valueOf(Save_Total_night_lw)){
                                textView_updown_totalman.setVisibility(View.VISIBLE);
                                textView_updown_totalman.setBackgroundResource(R.mipmap.dqaweekly_ic_lowering);
                            }else{
                                textView_updown_totalman.setVisibility(View.INVISIBLE);
...
//                                textView_updown_totalman.setBackgroundResource(R.mipmap.dqaweekly_ic_level);
                            ...
                            recyclerView_Adapter = new RecyclerViewAdapter(mContext, Night_Adapter_Item_List);
...
//                        Log.w("7880加班",String.valueOf(Save7880_Total_overtime));
                            ...
                            linear_night_up.setVisibility(View.GONE);
                            linear_night_down.setVisibility(View.GONE);
    ...
    //-------------------------Item-------------------------
    public class Night_Adapter_Item {
        ...
        public Night_Adapter_Item(String TotalMan,String F_DeptCode,String Delay)
        {
    ...
    public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder>{
        ...
        List<Night_Adapter_Item> values;
        Context context1;

        public RecyclerViewAdapter(Context context2, List<Night_Adapter_Item> values2){
        ...
        public class ViewHolder extends RecyclerView.ViewHolder{
            ...
            public TextView textView_dp_nighttime;
            ...
            public ViewHolder(View v){
                ...
                textView_dp_nighttime = (TextView) v.findViewById(R.id.textView_dp_nighttime);
        ...
        public RecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
            ...
            View view1 = LayoutInflater.from(context1).inflate(R.layout.msibook_dqaweekly_resource_recycle_item_night,parent,false);
        ...
        public void onBindViewHolder(final RecyclerViewAdapter.ViewHolder Vholder, final int position){
            ...
            Vholder.textView_dp_nighttime.setText(values.get(position).GetNight());
            ...
            if(values.get(position).GetNight().contains("N/A"))
            {
                Vholder.textView_dp_nighttime.setText(values.get(position).GetNight());
                Vholder.textView_updown.setVisibility(View.INVISIBLE);
            }else {
                if (Double.valueOf(values.get(position).GetNight()) > Double.valueOf(Night_Adapter_Item_List_LastWeek.get(position).GetNight())) {
                    Vholder.textView_updown.setBackgroundResource(R.mipmap.dqaweekly_ic_upgrade);
                } else if (Double.valueOf(values.get(position).GetNight()) < Double.valueOf(Night_Adapter_Item_List_LastWeek.get(position).GetNight())) {
