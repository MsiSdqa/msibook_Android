...
public class ProjectInfo extends Activity {
    ...
    private void Get_Model_Detail(String ModelID, String WorkID) {
        ...
        String Path = GetServiceData.ServicePathIMS + "/Find_Model_Detail?ModelID=" + ModelID + "&WorkID=" + WorkID;
            ...
            if (UserArray.length() > 0) {
                ...
                try {
                    Glide.with(ProjectInfo.this)
                            .load(GetServiceData.ServicePathIMS + "/Get_File?FileName=" + ModelPic)
                            .asBitmap()
    ...
    private void FavoriteClick(String F_Keyin, String F_Owner, String F_PM_ID) {
        ...
        HTTPSTrustManager.allowAllSSL();//信任所有证书，信任憑證
        String Path = GetServiceData.ServicePathIMS + "/Insert_Favorit_Model" + "?F_Keyin=" + F_Keyin + "&F_Owner=" + F_Owner + "&F_PM_ID=" + F_PM_ID;
