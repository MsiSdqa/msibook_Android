 ...
 * {@link project_expandtable.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link project_expandtable#newInstance} factory method to
...
public class project_expandtable extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_project_expandtable, container, false);
...
//        pDialog.show();
        ...
        {
            if (SortType == 0) {
                Path = GetServiceData.ServicePathIMS + "/Find_Project_List_By_Start_End?WorkID=" + WorkID + "&Start=" + Start + "&End=" + End;
            } else {
                Path = GetServiceData.ServicePathIMS + "/Find_Project_LastActive?WorkID=" + WorkID + "&Start=" + Start + "&End=" + End;
            }
        }
        else
        {
            Path = GetServiceData.ServicePathIMS + "/Find_Project_List_Search?WorkID=" + WorkID + "&Start=" + Start + "&End=" + End + "&SearchText=" + SearchString;
        }
...
//            Toast.makeText(Project.this,ex.getMessage(), Toast.LENGTH_LONG).show();
    ...
    class ExpandableAdapter extends BaseExpandableListAdapter {
        ...
        public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView,
            ...
            HTTPSTrustManager.allowAllSSL();//信任所有证书，信任憑證
            String ProjectImagePath = GetServiceData.ServicePathIMS + "/Get_File?FileName=" + Project_Item.GetImage();
        ...
        private void Insert_Forcus_Data(String F_Keyin, String F_Owner, String F_PM_ID) {
            ...
            HTTPSTrustManager.allowAllSSL();//信任所有证书，信任憑證
            String Path = GetServiceData.ServicePathIMS + "/Insert_Focus_Model" + "?F_Keyin=" + F_Keyin + "&F_Owner=" + F_Owner + "&F_PM_ID=" + F_PM_ID;
