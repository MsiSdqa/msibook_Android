...
public class msibook_msipay_register3_check_number extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_msibook_msipay_register3_check_number);
